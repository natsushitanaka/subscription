...
<div class="container">
    <div class="row justify-content-around box">
        ...
        <div class="col-6">
        <p class="info">1.まずはユーザー（店舗）の登録をします。<br>
            　各項目を入力し、登録します。</p>
            </div>
    </div>
    <div class="row justify-content-around box">
    ...
    <div class="row justify-content-around box">
        ...
        <div class="col-6">
        <p class="info">3.ログイン後、顧客登録します。<br>
            　・氏名、メールアドレスは必須です。<br>
            　・電話番号は店舗の必要に応じて登録します。<br>
            　・誕生日を登録すると当日メール配信、毎月初日に店舗へ通知メールが配信されます。<br>
            　　（誕生日のお客様への特別なサービスなど忘れずに実施するとこができます。）<br>
            　・サブスク利用者にはプランにチェックを入れます。<br>
            　　（サブスク利用者以外でも顧客管理としても活用できます。）
        </p>
        </div>
    </div>
    <div class="row justify-content-around box">
    ...
    <div class="row justify-content-around box">
        ...
        <div class="col-6">
        <p class="info">5.顧客の詳細情報を確認する。<br>
            　登録した情報の他、来店データを分析しお客様の特徴などが把握できます。<br>
            　登録した顧客情報の変更は「編集する」から可能です。
        </p>
        </div>
    </div>
    <div class="row justify-content-around box">
        ...
        <div class="col-6">
        <p class="info">5.顧客登録が完了すると、店舗の登録メールアドレスに<br>
            　顧客登録完了メールが配信されます（サブスク利用者のみ）。<br>
           　 このQRコードを来店時に提示してもらいます。</p>
           </div>
    </div>
    <div class="row justify-content-around box">
        <img src="demo_photo/スクリーンショット 2020-10-07 16.03.45.png" alt="来店データ" class="col-5">
        <div class="col-6">
        <p class="info">6.QRコードを読み取り、来店データ画面が表示されると本人認証完了です。<br>
        　下の表に来店日が自動で保存されます。<br>
        　この画面では手動での来店データを追加することができます。</p>
        </div>
    </div>
    <div class="row justify-content-around box">
        <img src="demo_photo/スクリーンショット 2020-10-07 13.21.58.png" alt="設定画面" class="col-5">
        <div class="col-6">
        <p class="info">7.店舗の各種設定を変更します。<br>
            　【デフォルト】<br>
            　有効期限：３０日<br>
            　メール配信時刻：１０：００<br>
            　失効事前通知メール配信日：７日前。<br>
            　【ポートフォリオ テスト用】<br>
            　自動設定を押すとすぐに、<br>
            　動作確認（失効事前メール・失効メール・サブスク利用解除処理）ができます。
        </p>
        </div>
    </div>
    <div class="row justify-content-around box">
        ...
        <div class="col-6">
        <p class="info">8.有効期限になると失効メールを配信し、サブスク利用を解除します。<br>
        　顧客情報のプランの項目が「×」に変わっているはずです。</p>
        </div>
    </div>
    <div class="row justify-content-around">
        <img src="demo_photo/スクリーンショット 2020-10-07 17.57.50.png" alt="非アクティブリスト" class="col-5 small">
        <div class="col-6">
            <p class="info">9.非アクティブ顧客リスト機能<br>
                　登録したが、しばらく来店のないお客様などをこちらに移すことで<br>
                　管理が楽になります。<br>
                　「再登録」するとまた顧客リストに戻すことができます。<br>
                　「完全削除」すると完全に削除され復元はできません。
            </p>
        </div>
    </div>
